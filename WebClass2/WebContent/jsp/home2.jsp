...
<html lang="ko">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" id = "LoginForm">
      ...
      <input class="form-control mr-sm-2" type="text" placeholder="Password" aria-label="Password" id = "Password" required>
...
<div class = "container">
  ...
  //  $(document).ready(function (){ê°ë¨íê² ì°ê¸°
  $(function(){
